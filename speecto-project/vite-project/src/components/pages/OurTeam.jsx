  ...
  return (
    <section className=" bg-gray-50">
      <div className="w-auto mx-auto px-4">
        <div className="relative mb-12 w-auto mx-auto">
          <img
          ...
          <div className="absolute inset-0 bg-black/60 flex flex-col items-center  text-center px-4">
            <h2 className="text-3xl mt-12 sm:text-4xl font-semibold text-white">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {teamMembers.map((mem, indx) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-60 text-white p-5 transition-all duration-300 group-hover:translate-y-0 translate-y-full">
                <h3 className="text-lg font-semibold">{mem.name}</h3>
                <p className="text-sm text-gray-200">{mem.role}</p>
                {mem.bio && <p className="mt-2 text-xs text-gray-100">{mem.bio}</p>}
              </div>
            </div>
          ))}
        </div>
