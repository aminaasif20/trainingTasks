...
const Section1 = () => {
  return (
    <div>
      <section className="flex flex-col items-center border-t-8 border-[#081533] bg-white px-5 py-16 text-center font-sans">
  
        <h1 className="mb-8 text-[20px] font-semibold uppercase tracking-[2.8px] text-[#081533]">
            How Do We Work
        </h1>
        
        <p className="mb-6 max-w-[850px] text-md leading-[1.8] text-[#081533]">
        ...
        <p className="max-w-[850px] text-md leading-[1.8] text-[#081533]">
